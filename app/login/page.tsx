    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-900 via-black to-zinc-900 p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-zinc-400 mb-6">Login to continue removing watermarks</p>

          {/* Google Login Button (placeholder) */}
          <button
            type="button"
            disabled
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white text-zinc-900 rounded-lg font-medium opacity-50 cursor-not-allowed mb-4"
          >
